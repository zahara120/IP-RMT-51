    ...
    <>
      <section className="mt-10">
        <div className="col-span-2 flex flex-col md:flex-row gap-12">
          <Link to={`/detail/${data?.data[0]?.id}`} className="h-fit w-full">
          ...
          <div className="grid grid-rows-2 gap-4 w-full">
            <Link to={`/detail/${data?.data[1]?.id}`} className="h-fit w-full">
              <Card className="w-full">
                <Image
                  removeWrapper
                  className="z-0 w-full h-full object-cover"
            ...
            <div className="flex gap-4 w-full">
              <Link to={`/detail/${data?.data[2]?.id}`} className="h-fit w-full">
                <Card className="w-full">
                  <Image
                    removeWrapper
                    className="z-0 w-full h-full object-cover"
              ...
              <Link to={`/detail/${data?.data[3]?.id}`} className="h-fit w-full">
                <Card className="w-full">
                  <Image
                    removeWrapper
                    className="z-0 w-full h-full object-cover"
